...
------------------------
 ...
 51 -- subpart., no filename s0                                         ok.
       Cmd: minget -p 0 -s 0 HardDisk                       
 52 -- subpart., no filename s2                                         ok.
...
-----------------
Test program output:
Child process (14099) exited due to SIGSEGV.
...
-----------------
Test program output:
Child process (14302) exited due to SIGSEGV.
...
-----------------
Test program output:
Child process (14591) exited due to SIGSEGV.
Program exited with bad status: 65280
...
Diffs: ( < Reference > Testfile ):
 --- Output limited to 10 lines. (There would be too much.) ---
Binary files /home/pn-cs453/Given/Asgn4/Expected/89 and testminfs.14000 differ
...
Diffs: ( < Reference > Testfile ):
 --- Output limited to 10 lines. (There would be too much.) ---
Binary files /home/pn-cs453/Given/Asgn4/Expected/94 and testminfs.14000 differ
